                ...
                "copies": [
                  {
                    "files": [
                      ...
                      "<(bin_folder)/libTKBO.7.2.0.dylib",
                      "<(bin_folder)/libTKBool.7.2.0.dylib",
                      "<(bin_folder)/libTKBRep.7.2.0.dylib",
                      "<(bin_folder)/libTKernel.7.2.0.dylib",
                      "<(bin_folder)/libTKFeat.7.2.0.dylib",
                      "<(bin_folder)/libTKFillet.7.2.0.dylib",
                      "<(bin_folder)/libTKG2d.7.2.0.dylib",
                      "<(bin_folder)/libTKG3d.7.2.0.dylib",
                      "<(bin_folder)/libTKGeomAlgo.7.2.0.dylib",
                      "<(bin_folder)/libTKGeomBase.7.2.0.dylib",
                      "<(bin_folder)/libTKIGES.7.2.0.dylib",

                      "<(bin_folder)/libTKMath.7.2.0.dylib",
                      "<(bin_folder)/libTKMesh.7.2.0.dylib",
                      "<(bin_folder)/libTKOffset.7.2.0.dylib",
                      "<(bin_folder)/libTKPrim.7.2.0.dylib",
                      "<(bin_folder)/libTKShHealing.7.2.0.dylib",
                      "<(bin_folder)/libTKSTEP.7.2.0.dylib",
                      "<(bin_folder)/libTKSTEP209.7.2.0.dylib",
                      "<(bin_folder)/libTKSTEPAttr.7.2.0.dylib",
                      "<(bin_folder)/libTKSTEPBase.7.2.0.dylib",
                      "<(bin_folder)/libTKSTL.7.2.0.dylib",
                      "<(bin_folder)/libTKTopAlgo.7.2.0.dylib",
                      "<(bin_folder)/libTKXSBase.7.2.0.dylib",
