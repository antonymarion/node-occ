...
// dummy functions
exports.makeStep = function () {
    return occ.makeBox([10, 20, 30], [10.01, 20.01, 30.01]);
};
const voidFn = function () {

};
exports.makeVoluBox = voidFn;
exports.makeVoluCylinder = voidFn;
exports.makeVoluSphere = voidFn;
exports.makeVoluTorus = voidFn;
exports.makeVoluCone = voidFn;
exports.makeVoluOperation = voidFn;
exports.makeVoluTransfo = voidFn;
// end dummy functions
